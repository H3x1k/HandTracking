            ...
            if norm[2] < -0.95:
                if index_pinch:
                    if is_index_pinch(hand_landmarks):
                        index_x, index_y = width * (1 - hand_landmarks.landmark[8].x), hand_landmarks.landmark[8].y * height
                        #last_index_x, last_index_y = last_index_position.x * w, last_index_position.y * h
                        mouse.position = (int(index_x), int(index_y))
                        #dx, dy = last_index_x - index_x, index_y - last_index_y
